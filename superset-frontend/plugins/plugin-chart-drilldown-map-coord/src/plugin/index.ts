...
import { DrilldownMapCoordChartProps, DrilldownMapCoordFormData } from './types';

export default class DrilldownMapCoordChartPlugin extends ChartPlugin<
  DrilldownMapCoordFormData,
  DrilldownMapCoordChartProps
> {
  /**
  ...
  constructor() {
    super({
      buildQuery,
      controlPanel,
      loadChart: () => import('../DrilldownMapCoord'),
      metadata: new ChartMetadata({
        ...
        name: t('Drilldown Map Coordinate'),
        tags: [
          t('Aesthetic'),
          t('Categorical'),
          t('Circular'),
